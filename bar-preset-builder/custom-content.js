window.CUSTOM_CONTENT = {
 ...
 "latest scav zombies mode june 2026": {
  "map": "Ancient Bastion Remake 0.5",
  "items": [
   {
    "id": "armthort4",
    "baseId": "armthor",
 ...
 "tetris scav mode + custom buildings": {
  "map": "Ancient Bastion Remake 0.5",
  "items": [
   {
    "id": "armthort4",
 ...
 "mark magic 9": {
  ...
  "items": [
   ...
   },
   {
    ...
    "baseId": "armflak",
    "name": "The Depawner",
    "tooltip": "Anti-air turret tuned to kill enemy drone-carriers fast.",
    "baseIcon": "armflak.png",
    "baseFaction": "Armada"
   },
   {
