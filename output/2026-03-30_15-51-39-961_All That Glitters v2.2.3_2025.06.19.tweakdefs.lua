...
legaap={H=4650,B=44600,M=3200,E=28500},
...
leggobt3={M=5000,E=90000},
legrail={M=260,E=4000,P=185,w={railgun={EPS=50,D={DEF=240,CMDRS=120},AOE=90,IMPB=300,CP={nodecal=true}},aa_railgun={CAG=false,D={VTOL=360}}}},
leghelios={H=890,IT=900,w={heat_ray={BTIME=0.44,EPS=12}}},
leggat={SD=333,TR=244,S=45.4,B=6000,UPCV=1,w={armmg_weapon={R=400,WV=921,D={VTOL=9}}}},
...
legsrail={P=480,M=900,E=18000,w={railgunt2={MVACC=700,AOE=130,IMPB=900,CP={nodecal=true}}}},
...
coresuppt3={TR=60,MAXA=0.005,MAXD=0.005,FBM=1.2,w={laser={CST=800,LLB=true,SCR=4,N="Armageddon Heat Ray",SS="heatray2xl",EG="custom:genericbuildingexplosion-metalmaker",COR=0.4,THICK=9,LFS=12,RT=7.5,SSV=95,AOE=90,EPS=3500,D={DEF=11250,VTOL=4500}}}},
armmls={WK=190},
...
corsiegebreaker={S=55.3,XPLD="hugeexplosiongeneric",SELFD="hugeExplosionGenericSelfd",E=36000,TR=75,TIPS=0.01,H=3600,FBMIN=0.8,FBM=2.4,w={dreadovercharge={EPS=5000,LFS=8,COR=0.2,THICK=4,BTIME=1.9,BDECAY=0.01,RT=11,D={DEF=6050}}}},
...
local map = {
	...
	BLC="blocking", CAT="category", FD="featuredefs", O="object", BP="buildpic", SFX="sfxtypes",
	MWD="minwaterdepth", ICT="icontype", EC="evolution_condition", ET="evolution_timer", EG2="evolution_target",
...
UnitDefs["legadvsol2"]=table.copy(UnitDefs["legadvsol"])
UnitDefs["armthovr"]=table.copy(UnitDefs["corhal"])
UnitDefs["corthovr"]=table.copy(UnitDefs["corhal"])
UnitDefs["legthovr"]=table.copy(UnitDefs["corhal"])
UnitDefs["corintr"]=table.copy(UnitDefs["corgarp"])
...
FD={dead={BLC=false,CAT="corpses",CVT="CylZ",FPX=4,FPZ=4,H=20,O="Units/armthovr_dead.s3o",REC=true}},
...
FD={dead={BLC=false,CAT="corpses",CVT="Box",H=20,O="Units/corthovr_dead.s3o",REC=true}},
...
FD={dead={BLC=true,CAT="corpses",CVT="Box",FD2="HEAP",FPX=4,FPZ=4,H=20,O="Units/corintr_dead.s3o",REC=true},heap={BLC=false,CAT="heaps",CVT="cylY",H=4,M=329,O="Units/cor4X4C.s3o",REC=true,RES=0}},
...
for _,n in ipairs{"legbar","legbart","leginf"}do local wd=u[n]and u[n].weapondefs if wd then for _,w in pairs(wd)do if w.D and w.D.DEF then w.D.shields=w.D.DEF*5 end end end end
...
for _,ud in pairs(u)do
	if not(ud.movementclass and ud.movementclass:sub(1,5)=="HOVER")  and not(ud.minwaterdepth and ud.minwaterdepth>0) then
		local d=(ud.extractsmetal and ud.extractsmetal>0) and 36 or 12
		if ud.maxwaterdepth and ud.maxwaterdepth<d then ud.maxwaterdepth=d end
	end
end
