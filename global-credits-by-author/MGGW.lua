-- MGGW -- content pulled from public BAR replays (bar-replay-miner global scan, 2026-08-15)
-- 2 distinct snippet(s), 65 total occurrences across scanned games

-- === "--Quad Pharos pick by MGGW DJ did some fix...." (seen 11x) ===
...
-- === "--Quad Pharos pick by MGGW" (seen 54x) ===
--Quad Pharos pick by MGGW DJ did some fix.... convertersize/afusmul = out.
local mods = Spring.GetModOptions()
local uDefs = UnitDefs or {}
local cps = 'customparams'
