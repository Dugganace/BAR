...
-- T3 Air Balance Patch - no factory insertion
...
u.weapons={
[1]={badtargetcategory="NOTLAND",def="PLASMA",maindir="-1 0 0",maxangledif=210,onlytargetcategory="SURFACE T4AIR"},
[2]={badtargetcategory="NOTLAND",def="PLASMA",maindir="1 0 0",maxangledif=210,onlytargetcategory="SURFACE T4AIR"},
[3]={def="SEMIAUTO",maindir="0 0 1",maxangledif=240,onlytargetcategory="SURFACE"},
[4]={def="SEMIAUTO",maindir="-1 0 0",maxangledif=190,onlytargetcategory="SURFACE"},
[5]={def="SEMIAUTO",maindir="1 0 