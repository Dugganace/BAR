...
u.weapondefs={heavy_assault_cannon={areaofeffect=48,avoidfeature=false,avoidfriendly=false,collidefriendly=false,craterareaofeffect=0,craterboost=0,cratermult=0,edgeeffectiveness=0.35,explosiongenerator="custom:genericshellexplosion-medium",firestarter=60,impulsefactor=0.08,name="Heavy Assault Cannon",noselfdamage=true,range=390,reloadtime=0.45,soundhit="SabotHit",soundhitwet="splshbig",soundstart="SabotFire",soundtrigger=true,turret=true,weapontype="Cannon",weaponvelocity=900,damage={default=125},},}
u.weapons={[1]={badtargetcategory="VTOL",def="HEAVY_ASSAULT_CANNON",onlytargetcategory="SURFACE"},}
end
...
u.weapons={[1]={def="HEAVYPLASMA",onlytargetcategory="SURFACE T4AIR",},[2]={def="MEDIUMPLASMA",maindir="0 0 1",maxangledif=320,onlytargetcategory="SURFACE T4AIR",},[3]={def="HEAVYPLASMA",maindir="0 0 1",maxangledif=240,onlytargetcategory="SURFACE T4AIR",},[4]={def="MEDIUMPLASMA",maindir="-4 0 1",maxangledif=180,onlytargetcategory="SURFACE T4AIR",},[5]={def="MEDIUMPLASMA",maindir="4 0 1",maxangledif=180,onlytargetcategory="SURFACE T4AIR",},[6]={badtargetcategory="NOTAIR GROUNDSCOUT",def="FERRET_MISSILE",maindir="0 -1 -2",maxangledif=270,onlytargetcategory="VTOL T4AIR",},[7]={badtargetcategory="NOTAIR GROUNDSCOUT",def="FERRET_MISSILE",onlytargetcategory="VTOL T4AIR",},[8]={badtargetcategory="NOTAIR GROUNDSCOUT",def="FLAK",onlytargetcategory="VTOL T4AIR",},[9]={badtargetcategory="NOTAIR GROUNDSCOUT",def="FLAK",onlytargetcategory="VTOL T4AIR",},}
end
...
u.weapons={[1]={badtargetcategory="VTOL",def="NUCLEAR_MISSILE",onlytargetcategory="SURFACE",},}
end
...
if u.weapondefs then
u.weapondefs.heavyplasma={areaofeffect=64,avoidfeature=false,avoidfriendly=false,beamtime=1.5,beamttl=2,corethickness=0.65,craterareaofeffect=0,craterboost=0,cratermult=0,camerashake=0,cylindertargeting=1,edgeeffectiveness=0.15,energypershot=0,explosiongenerator="custom:genericshellexplosion-medium-beam",firestarter=100,impactonly=1,largebeamlaser=true,texture3="largebeam",tilelength=120,scrollspeed=4,beamdecay=0.05,impulsefactor=0,laserflaresize=14,name="Death Star Superlaser",noselfdamage=true,range=1150,reloadtime=6,rgbcolor="0.1 1.0 0.2",rgbcolor2="0.6 1.0 0.5",soundhitdry="",soundhitwet="sizzle",soundstart="lasrhvy3",soundtrigger=1,thickness=30,tolerance=10000,turret=true,weapontype="BeamLaser",weaponvelocity=1200,damage={commanders=3000,default=30000,subs=3000,vtol=30000,},}
end
...
s.reloadtime=0.1
s.accuracy=180
s.damage=s.damage or {}
s.damage.default=80
s.damage.vtol=120
end
local a=u.weapondefs.aa_missiles
if a then
a.range=1400
a.reloadtime=0.5
a.flighttime=8
a.turnrate=65000
a.weaponacceleration=1000
a.weaponvelocity=1400
a.damage=a.damage or {}
a.damage.vtol=300
end
end
u.weapons={[1]={badtargetcategory="NOTLAND",def="PLASMA",maindir="-1 0 0",maxangledif=210,onlytargetcategory="SURFACE T4AIR"},[2]={badtargetcategory="NOTLAND",def="PLASMA",maindir="1 0 0",maxangledif=210,onlytargetcategory="SURFACE T4AIR"},[3]={def="SEMIAUTO",maindir="0 0 1",maxangledif=240,onlytargetcategory="SURFACE"},[4]={def="SEMIAUTO",maindir="-1 0 0",maxangledif=190,onlytargetcategory="SURFACE"},[5]={def="SEMIAUTO",maindir="1 0 0",maxangledif=190,onlytargetcategory="SURFACE"},[6]={def="AA_MISSILES",maindir="1 0 0",onlytargetcategory="VTOL"},}
end
