-- T3 Coms Early Infrastructure + Scout Boost by Bezz-- T3 Com Cons
do
    local privatePairs={
        {"armck","armckx"},
        {"armcv","armcvx"},
        {"armbeaver","armbeaverx"},
        {"armca","armcax"},
        {"corck","corckx"},
        {"corcv","corcvx"},
...
do
local pairsIconFix={
  armck="armckx",armcv="armcvx",armbeaver="armbeaverx",armca="armcax",
  corck="corckx",corcv="corcvx",cormuskrat="cormuskratx",corca="corcax",
  legck="legckx",legcv="legcvx",legotter="legotterx",legca="legcax",
}
