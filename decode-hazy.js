...
const raw = JSON.parse(fs.readFileSync(path.join(__dirname, 'hazy-data', 'hazy-clean.json'), 'utf8'));
const OUT_DIR = path.join(__dirname, 'hazy-data');
...
console.log(`${raw.length} of his games had tweak fields; ${results.length} had non-empty tweakdefs/tweakunits; ${groups.size} distinct content sets.\n`);
