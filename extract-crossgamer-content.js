...
const OUT_DIR = path.join(__dirname, 'crossgamer-data');
...
fs.writeFileSync(path.join(__dirname, 'crossgamer-custom-content.json'), JSON.stringify([...allItems.values()], null, 1));
